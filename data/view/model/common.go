...
import (
	...
	"github.com/zcpua/gormt/data/view/cnf"
	"github.com/zcpua/gormt/data/view/genfunc"
)
...
func getTypeName(name string, isNull bool) string {
	...
	panic(fmt.Sprintf("type (%v) not match in any way.maybe need to add on (https://github.com/zcpua/gormt/blob/master/data/view/cnf/def.go)", name))
}
