...
or: [Dowloading](https://github.com/zcpua/gormt/releases)
...
- Support function export (foreign key, association, index , unique and more)[Support export function >>>](https://github.com/zcpua/gormt/blob/master/data/view/genfunc/genfunc_test.go)
...
### [more>>>](https://github.com/zcpua/gormt/tree/master/doc/func.md)
### [how to use call style>>>](https://github.com/zcpua/gormt/blob/master/data/view/genfunc/genfunc_test.go)
...
[Download](https://github.com/zcpua/gormt/releases/download/v0.3.8/v1.0.zip)
